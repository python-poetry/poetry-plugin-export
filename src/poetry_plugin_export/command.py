...
class ExportCommand(GroupCommand):
    ...
    options = [
        ...
        option(
            "with",
            None,
            # note: unlike poetry install, the default excludes all groups (including non-optional)
            (
        ...
        option(
            "without",
            None,
            # deprecated: since groups are always excluded by default, this option serves no purpose.
